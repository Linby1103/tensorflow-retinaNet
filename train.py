...
data = [r'D:\install\RetinaNet\RetinaNet-tensorflow\data\test_00001-of-00002.tfrecord'
        ]
...
retinanet.load_weight('./retina/test_2273.90673828125-30100')
for i in range(epochs):
    ...
    if i%30==0 and i!=0:
        retinanet.save_weight('latest', './retina/test_{}'.format(mean_loss))         # 'latest' 'best'
